...
function main() {
  ...
  console.log("   1. Mettez à jour vos balises <img> pour utiliser les fichiers .webp");
  console.log("   2. Utilisez l'élément <picture> avec fallback pour les anciens navigateurs:");
  console.log("      <picture>");
